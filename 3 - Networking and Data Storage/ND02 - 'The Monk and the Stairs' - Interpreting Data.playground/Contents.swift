...
import Foundation
func sumOfAllInts(arrays: [[Int]]) -> Int {
    let totalInOneYear = arrays.flatMap { $0 }.reduce(0, +)
    return totalInOneYear * 20
}
let stairs = [
    [100, 120, 110],  // Sundays
    [130, 140, 135],  // Mondays
    [110, 115, 120],  // Tuesdays
    [140, 145, 150],  // Wednesdays
    [120, 125, 130],  // Thursdays
    [150, 155, 160],  // Fridays
    [130, 135, 140]   // Saturdays
]
let result = sumOfAllInts(arrays: stairs)
print(result)
