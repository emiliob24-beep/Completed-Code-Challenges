...
func years(humanYears: Int) -> (humanYears: Int, catYears: Int, dogYears: Int) {
    let catYears = humanYears * 15
    let dogYears = humanYears * 7
    return(humanYears, catYears, dogYears)
}
let result = years(humanYears: 10)
print(result.humanYears)
print(result.catYears)
print(result.dogYears)
