...
func countSentences(_ sentence: String) -> Int {
    let text = "Alas, poor Yorick! I knew him, Horatio: a fellow of infinite jest, of most excellent fancy: he hath borne me on his back a thousand times; and now, how abhorred in my imagination it is! my gorge rims at it."
    var count = 0
    
    text.enumerateSubstrings(in: text.startIndex..., options: .bySentences) {substring,substringRange,enclosingRange,_ in 
        if Substring.self != nil {
            count += 1
        }
    }
    return 0
